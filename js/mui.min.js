	...
	plus.oauth.getServices(function (services) {
		...
		wxLoginObj.logout(function () {
			plus.storage.removeItem('suid');
						...
						index.evalJS('changeSub(1); document.getElementById("nav4").classList.remove("mui-active");document.getElementById("nav1").classList.add("mui-active")')
		}, function () {
